...
namespace BufTools.DataStore.EntityFramework
{
    ...
    public class AutoRegisterDbContext : DbContext
    {
        ...
        {
            var methods = type.GetMethods().Where(info => Attribute.IsDefined(info, typeof(StoredFunctionAttribute)));
            ...
            {
                var attribute = method.GetCustomAttributes(typeof(StoredFunctionAttribute), true).First() as StoredFunctionAttribute;
